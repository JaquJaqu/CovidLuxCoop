...
//Enjoy :D 
 ...
 const urlB = 'https://covid19-dashboard.ages.at/data/CovidFaelle_Timeline.csv';
//  const corsFix = 'https://cors-anywhere.herokuapp.com/';
//  const corsFix = 'http://127.0.0.1:5500//cors-anywhere';


let path = corsFix + urlB;
let pathbool = true;
...
function read_from_local_storage() { 
  ...
  let dataEinBundesland = dataOffline.filter(function(AnzahlTotTaeglich){
    return AnzahlTotTaeglich.Bundesland =="Burgenland"; 
  })
  let BlAnzahlFaelle = dataEinBundesland[dataEinBundesland.length-1].AnzahlFaelle
   console.log(BlAnzahlFaelle); 
} else{
